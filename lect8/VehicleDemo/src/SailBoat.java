...
public class SailBoat extends Vehicle{
	...
	public SailBoat(String _powerSource, int _wheels, double _price) {
	...
	public void setPrice(double _price) {
		...
		System.out.println("SailBoat implementation of setPrice()");
	...
	{
		return "SailBoat power source is " + powerSource + "\n"
